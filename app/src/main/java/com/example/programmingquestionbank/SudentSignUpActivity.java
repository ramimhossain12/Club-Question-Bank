...
public class SudentSignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sudent_sign_up);
    ...
    public void onClick(View v) {
        ...
        switch ( v.getId()){
            case R.id.signUpButtonID:
                Intent in = new Intent(getApplicationContext(), StudentLoginActivity.class);
                startActivity(in);
                userRegister();
                break;
